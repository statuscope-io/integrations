...
# A sample script that notifies Statuscope.io of used disk space by a mongodb server
...
if [ "$#" -ne 6 ]; then
    ...
    echo "Example: ./check_website.sh 10.10.0.0:27017/testdb testuser sknEzEc8apLP41Zg 1ba012f74 HwPK5JZSHkYzFpA 1024"
    exit 1
fi
